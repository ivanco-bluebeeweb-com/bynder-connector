"""Pydantic schemas for Bynder Connector (C33. Digital Asset Management)."""
...
class ConnectParams(BaseModel):
    label: str = Field(default="", description="Friendly connection label, e.g. Primary Bynder.")
    auth_token: str = Field(description="Bynder Permanent API Token or OAuth 2.0 Bearer token.")
    base_url: str = Field(default="https://api.bynder.com/api/v4", description="Bynder API base URL.")
